...
from project.datasets.maf.util import logit, disp_imdata, one_hot_encode, logistic
...
class MNIST:
    ...
    def __init__(self, logit=False, dequantize=True):
        ...
        # load dataset
        f = gzip.open(os.path.join(os.path.dirname(__file__), "data/mnist/mnist.pkl.gz"), "rb")
